...
impl VoiceConverter for ElevenLabsConverter {
    async fn convert_voice(
        ...
        headers.insert("xi-api-key", api_key.parse().unwrap());
        ...
        let form = multipart::Form::new()
            ...
            .part(
                "model_id",
                multipart::Part::text("eleven_multilingual_sts_v2"),
            );
        ...
        let response = client
            .post(format!(
                "https://api.elevenlabs.io/v1/speech-to-speech/{}/stream?output_format={}",
